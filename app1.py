...
model = joblib.load("RTA_MODEL.joblib")
...
# predict the target from all the input features
              ...
              if prediction == 0:
                    st.write('<p style="font-size:26px; color:red;">THE SEVERITY IS FATAL⚠</p>',
unsafe_allow_html=True)
              elif prediction == 1:
                      st.write('<p style="font-size:26px; color:red;">THE SEVERITY IS SERIOUS</p>',
unsafe_allow_html=True)
              else:
                      st.write('<p style="font-size:26px; color:red;">THE SEVERITY IS MINOR</p>',
unsafe_allow_html=True)
